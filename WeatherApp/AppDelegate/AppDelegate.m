...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    _loadingVC.loadDataFinished = ^()
    {
        [weakSelf loadForecastController];
    };
    
    self.window.rootViewController = _loadingVC;
    return YES;
}

- (void)loadForecastController
{
    ForecastViewController *forecastVC = [ForecastViewController new];
